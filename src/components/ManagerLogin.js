...
const navigate = useNavigate()
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:4000/login-manager', mgr);
          console.log(response)
            const user = response.data[0]

            window.sessionStorage.setItem('Shop_id', mgr.Shop_id)
        ...
        <motion.div
            ...
            <div className="flex flex-col ">
                ...
                <input type="text" name="" id="" style={{ 'background-color': '#fff6f4' }} className='focus:ring-orange-500 rouded-2xl  mx-8 p-2 '
                    ...
                    onChange={(e) => setMgr({ ...mgr, Shop_id: e.target.value })}
                />
                ...
                <motion.input
                    ...
                    onChange={(e) => setMgr({ ...mgr, mgr_id: e.target.value })}
                ...
                <input type="password" name="" id="" style={{ 'background-color': '#fff6f4' }} className='rouded-2xl  mx-8 p-2 '
                    onChange={(e) => setMgr({ ...mgr, pass_word: e.target.value })}
                />
            ...
            <div className="my-4 flex flex-row justify-center items-center mx-4 ">
                <Link className="text-orange-500" to="/Customer-login">  Login as Customer </Link>
